...
def get_twitter_stats():
    ...
    stats = twitter_soup.findAll(
        "span",
        class_=
        "css-901oao css-16my406 r-1qd0xha r-vw2c0b r-ad9z0x r-bcqeeo r-qvutc0")
...
def get_insta_stats():
    ...
    stats = insta_soup.findAll("span")
    posts = stats[1].text.strip()
    followers = stats[2].text.strip()
    following = stats[3].text.strip()
    print("Instagram Stats: {} posts, {} followers, and {} following".format(posts, followers, following))
